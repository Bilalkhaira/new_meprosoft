...
namespace App\Http\Controllers\Admin\ProductAndSolution;
...
class ProductAndSolutionController extends Controller
{
    ...
    public function storeCard(Request $request)
    {
        ...
        toastr()->success('Created Successfully');
        return redirect()->route('productAndSolution.index',  $navbar_id->menu_id);
    }
    ...
    public function updateCard(Request $request)
    {
        ...
        return redirect()->route('productAndSolution.index', $parrent->menu_id);
    }
