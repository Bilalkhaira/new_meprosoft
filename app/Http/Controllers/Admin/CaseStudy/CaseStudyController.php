...
class CaseStudyController extends Controller
{
    ...
    {
        $services = NavMenu::with('children')->where('name', 'Case Study')->get();
        ...
        return view('admin.pages.caseStudy.index', ['services_lists' => Arr::get($services, '0.children'), 'pageData' => $pageData, 'navbar_id' => $menu_id]);
    }
    ...
    public function getServicePage(Request $request)
    {
        ...
        return view('admin.pages.caseStudy.index', ['services_lists' => Arr::get($services, '0.children'), 'pageData' => $pageData, 'navbar_id' => $request->navbar_id]);
    }

    public function createToSection(Request $request)
    {
        return view('admin.pages.caseStudy.createToSection', ['parent_id' => $request->nvbar_id]);
    }

    public function storeToSection(Request $request)
    {
        $imgpath = public_path('img/caseStudy/');
        ...
        return redirect()->route('caseStudy.index', $query->menu_id);
    }
    ...
    public function editToSection($id)
    {
        ...
        return view('admin.pages.caseStudy.editToSection', ['topsectionData' => $topsectionData, 'update_id' => $id]);
    }
    ...
    public function updateToSection(Request $request, $id)
    {
        ...
        return redirect()->route('caseStudy.index', $updated_row->menu_id);
    }


    public function createExplanationSection($id)
    {
        return view('admin.pages.caseStudy.createExplanationSection', ['updated_id' => $id]);
    }
    ...
    public function editExplanationSection($id)
    {
        ...
        return view('admin.pages.caseStudy.editExplanationSection', ['explanationSection' => $explanationSection, 'update_id' => $id]);
    }
    ...
    public function storeCard(Request $request)
    {
        ...
        toastr()->success('Created Successfully');
        return redirect()->route('caseStudy.index',  $navbar_id->menu_id);
    }
    ...
    public function updateCard(Request $request)
    {
        ...
        return redirect()->route('caseStudy.index', $parrent->menu_id);
    }
