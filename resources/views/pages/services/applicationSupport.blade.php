...
<div class="container">
  <div class="row paperLess_row">
    ...
    <div class="col-md-12">
      ...
      <p><a href="{{ route('contactUs') }}">Get in touch with us right now to find out more about how Mesprosoft's application support services can enhance the dependability and performance of your software programmes while delivering a superior user experience.</a></p>
    </div>
  </div>
  <div class="row paperLess_form_sec">
    ...
    <div class="col-md-7 point_col">
      <div class="row">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/287426_Global learning_R_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
      ...
      <div class="row news_row_margin">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/288003_iLM_v1_R_neg_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
