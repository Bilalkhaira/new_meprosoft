...
<div class="container">
  ...
  <div class="row paperLess_form_sec">
    ...
    <div class="col-md-7 point_col">
      <div class="row">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/287137_Product Update_1_R_neg_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
      ...
      <div class="row news_row_margin">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/287130_71132_RequirementModel_R_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
      ...
      <div class="row news_row_margin">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/287137_Product Update_1_R_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
