...
<div class="container">
  <div class="row paperLess_row">
    ...
    <div class="col-md-6">
      ...
      <a href="{{ route('contactUs') }}"> Contact us today to learn more about how we can help you leverage the power of Dispatch Automation to transform your business.</a>
    </div>
  </div>
  <div class="row paperLess_form_sec">
    ...
    <div class="col-md-7 point_col">
      ...
      <div class="row news_row_margin">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/288194_Digital.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
      ...
      <div class="row news_row_margin">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/288193_Digital.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
