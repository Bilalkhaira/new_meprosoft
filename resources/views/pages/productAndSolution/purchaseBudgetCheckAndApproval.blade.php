...
<div class="container">
  <div class="row paperLess_row">
    ...
    <div class="col-md-6">
      ...
      <a href="{{ route('contactUs') }}"> Contact us today to learn more about how we can help you leverage the power of Purchase Budget Check & Approval to transform your business.</a>
    </div>
  </div>
  <div class="row paperLess_form_sec">
    ...
    <div class="col-md-7 point_col">
      <div class="row">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/285668_ModelCompany_R_neg_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
      ...
      <div class="row news_row_margin">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/291075_Continuous_attention_to_excellence_R_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
