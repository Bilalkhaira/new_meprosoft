...
<section class="hdr_bg">
  <div class="container-fluid wrapper bg-image" id="service_head_img" data-image-src="{{ asset('img/new_design_img/BTP.png' )}}"></div>
  <div class="img_dv">
    <div class="row">
...
<div class="container">
  <div class="row paperLess_row">
    <div class="col-md-6">
      <img src="{{ asset('img/new_design_img/54.png') }}" width="100%" alt="">
    </div>
    <div class="col-md-6">
  ...
  <div class="row paperLess_form_sec">
    ...
    <div class="col-md-7 point_col">
      <div class="row">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/285961_Circles_R_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
      ...
      <div class="row news_row_margin">
        <div class="col-md-2">
          <img src="{{ asset('img/new_design_img/icons/286242_Canada-Globe_R_orange.png') }}" width="60%" alt="">
        </div>
        <div class="col-md-10">
