...
<section class="hdr_bg">
  <div class="container-fluid wrapper bg-image" id="service_head_img" data-image-src="{{ asset('img/new_design_img/OptimizedMRP.jpg' )}}"></div>
  <div class="img_dv">
    <div class="row">
  ...
  <div class="col-md-12 text-center mb-6">
    ...
    <div class="col-md-8 point_col">
      ...
      <div class="row news_row_margin">
        <div class="col-md-3 text-right">
          <img src="{{ asset('img/new_design_img/icons/293468_ireland_bread_R_orange.png') }}" width="40%" alt="">
        </div>
        <div class="col-md-9">
