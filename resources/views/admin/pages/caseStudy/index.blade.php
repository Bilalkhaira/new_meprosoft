            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 setting_main">
                        <form action="{{ route('caseStudy.getServicePage') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 setting_main">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-10">
                                <img src="{{ asset('img/caseStudy/'.$pageData->topSection_img )}}" alt="">
                            </div>

                        </div>

                        <div style="float: right;">
                            <a href="{{ route('caseStudy.editToSection',$pageData->id) }}" class="btn btn-sm btn-primary">Edit</a>

                        </div>
                        @else
                        <div style="float: right;">
                            <form action="{{ route('caseStudy.createToSection') }}" method="POST">
                                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 setting_main">
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-md-4 col-lg-2 label">Background Image</label>
                            <div class="col-md-8 col-lg-10">
                                <form action="{{ route('caseStudy.deleteExplanationImage', $pageData->id ) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')"> <i class="fa fa-trash"></i></button>
                                </form>
                                <img src="{{ asset('img/caseStudy/'.$pageData->explanationSection_img )}}" alt="">
                            </div>

                        </div>
                        @endif
                        <div style="float: right;">
                            <a href="{{ route('caseStudy.editExplanationSection', $pageData->id ?? '') }}" class="btn btn-sm btn-primary">Edit</a>
                        </div>
                        @else
                        <div style="float: right;">
                            <a href="{{ route('caseStudy.createExplanationSection', $pageData->id ?? '') }}" class="btn btn-sm btn-primary">Create</a>
                        </div>
                        @endif
                        @else
                        <div style="float: right;">
            ...
            <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('caseStudy.storeCard') }}" method="POST">
                            @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-3 setting_main">
                                ...
                                <div class="card_btn">
                                    <form action="{{ route('caseStudy.deleteCard', $val->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal fade" id="editCard" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ route('caseStudy.updateCard') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="pt-3 setting_main">
