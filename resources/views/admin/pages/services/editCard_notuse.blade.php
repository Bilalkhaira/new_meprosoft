            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 setting_main">
                        <form action="{{ route('service.updateCard', $cardData->id ) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <label class="col-md-4 col-lg-2 label"> Card Heading</label>
                                <div class="col-md-8 col-lg-10">
                                    <input name="heading" class="form-control" type="text" value="{{ $cardData->heading ?? ''}}" required>
                                </div>
                            </div>
                            <div class="append-elements">
                                @foreach(json_decode($cardData['explanation']) as $key => $val)
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="lists[]" class="form-control" value="{{ $val }}" type="text" required>
                                    </div>
